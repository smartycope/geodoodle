...
export default class Line {
  ...
  get valid() {
    return this.a && this.b && !this.a.eq(this.b)
  }
  ...
  render(state, key = this.hash(), props = {}, enableGlow = true) {
    ...
    return (
      <line
        ...
        strokeDasharray={this.aes.dash
          .replace(/\s/, "")
          .split(",")
          .map((i) => i / state.scalex)
          .join(",")}
  ...
  hash() {
    ...
    if (this.a._x > this.b._x) return `${this.a.hash()}${this.b.hash()}`
    else if (this.a._x < this.b._x) return `${this.b.hash()}${this.a.hash()}`
    else if (this.a._y > this.b._y) return `${this.a.hash()}${this.b.hash()}`
    else return `${this.b.hash()}${this.a.hash()}`
  }
  eq(other) {
    return this.a.eq(other.a) && this.b.eq(other.b)
  }
  in(lines) {
    return lines.some((i) => this.eq(i))
  }
  remove(lines) {
    return lines.filter((i) => !this.eq(i))
  }
  align(state) {
    return this.copy(this.a.align(state), this.b.align(state))
  }
  rotate(angle, origin) {
    return this.copy(this.a.rotate(angle, origin), this.b.rotate(angle, origin))
  }
  flip(mirrorAxis, origin) {
    return this.copy(this.a.flip(mirrorAxis, origin), this.b.flip(mirrorAxis, origin))
  }
  ...
  static fromJSON(json) {
    return new Line({}, Point.fromJSON(json.a), Point.fromJSON(json.b), json.aes, json.props)
  }
  ...
  closeTo(other, threshold) {
    return this.a.closeTo(other.a, threshold) && this.b.closeTo(other.b, threshold)
  }
  slope() {
    return (this.b.y - this.a.y) / (this.b.x - this.a.x)
  }
  relativeTo(newOrigin) {
    return this.copy(this.a.relativeTo(newOrigin), this.b.relativeTo(newOrigin))
  }
  translate(...args) {
    return this.copy(this.a.translate(...args), this.b.translate(...args))
  }
  asGeoJson() {
    return turf.lineString([this.a.xy(), this.b.xy()])
  }
  ...
  static getCurrentLine(state) {
    if (!state.curLinePos) return null
