...
const icon = (unscale, props) => (
  <circle
    cx={xy} cy={xy} r={r / unscale}
    strokeWidth={3 / unscale}
    fill="none"
    stroke="currentColor"
    {...props}
  />
...
const DoNotDisturbAltIconSvg = <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8 0-1.85.63-3.55 1.69-4.9L16.9 18.31C15.55 19.37 13.85 20 12 20m6.31-3.1L7.1 5.69C8.45 4.63 10.15 4 12 4c4.42 0 8 3.58 8 8 0 1.85-.63 3.55-1.69 4.9"></path>
...
export const MirrorRotIcon = (rot, alt = false, unscale = 1, svgIcon=true) => {
  ...
  if (svgIcon)
    return <SvgIcon><svg {...svgProps}>{rtn}</svg></SvgIcon>
  else
    return rtn
}
