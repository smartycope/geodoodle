...
export function HelpMenu({state, dispatch}){
    ...
    const mobileSteps = [
        {content: 'Welcome to GeoDoodle!'},
        {   selector: '#menu-selector-mobile',
            content: 'This is the controls bar. You can click the 3 bars on the right to hide it',
        },
        {
            selector: "delete-menu",
            content: "This menu lets you delete lines",
            // action: () => document.querySelector('#delete-menu-button').click(),
        },
    ...
    return <div>
        ...
        <Tour
            steps={state.mobile ? mobileSteps : desktopSteps}
            isOpen={inTour}
