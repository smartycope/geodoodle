    ...
    <>
      ...
      <Concept title="Lines">
        ...
        <Concept title="Removing Lines">
          erase all lines at a point (or bounds or origins or whatever else) erase a single line by selecing both points
        </Concept>
      </Concept>
      ...
      <Concept title="Mirroring">
        ...
        <Concept title="Origins">
          Mirror & rotate around a specific point, instead of the cursor or center of the paper. Be careful! They can
          get messy quick. Theres a limit of 12, and you will probably only ever need 1 or 2.
        </Concept>
      </Concept>
