    ...
    return [
        {
            content: (
                <>
                    Welcome to GeoDoodle! This is a doodle program, but <em>not</em> a drawing program. All the lines
                    are intended to line up with the dots. This lets you repeat patterns in interesting ways.
                    <br />
                    <br />
        ...
        },
        {
            ...
            content: (
                <>
                    This is the toolbar. You can click the button on the far right to minimize it. You can also change
                    the side of the screen it sticks to in settings.
                </>
            ),
        },
        menu({ open: "color" }),
        {
            ...
            content: (
                <>
                    This is the color menu. You can use it to customize lines, including color, transparency, width, and
                    dash pattern.
                </>
            ),
        },
        ...
        },
        {
            ...
            content: (
                <>
                    There are 3 ways to mirror lines: around the cursor, the center of the page, or around a specific
                    spot.
                </>
            ),
        },
        ...
        menu({ open: "select" }),
        {
            ...
            content: (
                <>
                    ...
                    {mobile ? " You can also tap and hold to add a bound" : " You can also press 'b' to add a bound"},
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    Partial lines are lines that only have one end inside the selected area.
                </>
            ),
        },
        menu({ open: "delete" }),
        ...
        menu({ open: "navigation" }),
        {
            ...
            content: (
                <>
                    This is the navigation menu. You can set the current position and scale here manually. Additionally,
                    you can
                    {mobile
        ...
        },
        {
            ...
            content: (
                <>
                    This is one of the transformations you can apply to the pattern. There are 4 kinds of
        ...
        clickOn("#tour0-90"),
        {
            ...
            content: (
                <>
                    ...
                    while the boxes on the left control transformations applied to rows. The inner box is
                    &quot;every&quot;, while the outside box is the transformation applied. So this one reads &quot;once
                    every 2 columns, rotate the pattern 90°&quot;. The button in the corner resets the current
                    transformation.
                </>
            ),
        },
