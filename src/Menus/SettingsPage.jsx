        ...
        <Page menu="settings">
            <List subheader={<StyledSubheader>General</StyledSubheader>}>
                ...
                <Setting label="Dark Mode" help="Controls if the app is in dark mode or not">
                    <Select value={themeMode} onChange={(e) => dispatch({ themeMode: e.target.value })}>
                ...
                <Setting desktopOnly label="Invert Scroll" help="Controls if the scroll is inverted">
                    <Checkbox checked={invertedScroll} onChange={() => dispatch({ invertedScroll: !invertedScroll })} />
                </Setting>
                ...
                <Setting
                    label="Dots above fill"
                    help="Controls if the dots are displayed above the filled areas or not"
                >
                ...
                <Setting label="Max Undo Amount" help="Controls how many consecutive undos you can do at once">
                    <Number onValueChange={(val) => dispatch({ maxUndoAmt: val })} value={maxUndoAmt} min={2} />
                </Setting>
                ...
                <Setting label="Device Mode" help="Controls if the app is in mobile or desktop mode (experimental)">
                    <Select value={state.mobile} onChange={(e) => dispatch({ mobile: e.target.value })}>
